...
const Profile = () => {
  ...
  return (
    <div>
      <h1 className='cherry-bomb-one-regular text-4xl sm:py-2 lg:text-5xl leading-loose text-[#414141] flex justify-center'> Your Profile</h1>
      <div className='flex justify-center mb-10'><p className='w-40 mt-2 h-[1px] bg-[#414141]'></p></div>

      {/* avatar upload section */}

      <div className="flex flex-col items-center gap-4">
            <div className="relative">
              <img src={selectedImg || authUser.profilePic || avatar} alt="profileImg" className="size-32 rounded-full object-cover border-4 "/>
